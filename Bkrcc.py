...
with open (r"C:\Users\nazrul\Desktop\SingleL\TESTING-main\INPUT\ASBI-191022.txt") as file:
    ...
    for i in tqdm (range(0,total_lines)):
        pdf.add_page()
        pdf.image(r'C:\Users\nazrul\Desktop\SingleL\TESTING-main\IMAGES\MiB-02.jpg',30,15,50)
     ...
     #   pdf.image(r'C:\Users\nazrul\Desktop\SingleL\TESTING-main\IMAGES\MiB-03.jpg', 20, 260 , 15)        
        ...
        pdf.set_font('Arial','',10)
        pdf.cell(10)
        pdf.cell(10,150,txt = 'anda boleh menyemak maklumat terperinci di Maybank2U. Bagi akaun pembayaran melalui Arahan.')


        pdf.ln(1)
        pdf.set_font('Arial','',10)
        pdf.cell(10)
        pdf.cell(10,160,txt = 'Bayaran dan tarikh pembayaran adalah pada.')
        

        pdf.ln(1)
        pdf.set_font('Arial','I',10)
        pdf.cell(10)
        pdf.cell(50,180,txt = 'Kindly settle all progressive interest due before the commencement date of the instalment amount in order ')

        pdf.ln(1)
        pdf.set_font('Arial','I',10)
        pdf.cell(10)
        pdf.cell(50,216,txt = 'to avoid penalty interest being imposed.')
        ...
        pdf.set_font('Arial','',10)
        pdf.cell(10)
        pdf.cell(10,306,txt = 'YANG BENAAAAAAAAAAAAAAAAAAAAAAAAAAAARRRRRRRRRRRR :)')

        pdf.ln(1)
        pdf.set_font('Arial','',10)
        pdf.cell(10)
        pdf.cell(10,312,txt = 'NAZZZZZZZZZZZZZZZZZZZZRUL')
...
###############################################################PAGE 2##################################################################
        ...
        pdf.add_page()
        pdf.rotate(180,105,160)
        pdf.image(r'C:\Users\nazrul\Desktop\SingleL\TESTING-main\IMAGES\SelfMailer-02.png',5, 10,200)
        #if pagenum 
        pdf.ln(6)                           #keee align kanaannnnnnnnnnnn
        pdf.set_font('Arial','B',10)
        pdf.cell(60)
        pdf.cell(10,450,txt = name[i]
                 
                 )
    
        pdf.ln(1)
        pdf.cell(60)
        pdf.cell(10,460,txt = add1[i])

        pdf.ln(1)
        pdf.cell(60)
        pdf.cell(10,470,txt = hno[i])

        pdf.ln(1)
        pdf.cell(60)
        pdf.cell(10,480,txt = add2[i])

        pdf.ln(1)
        pdf.cell(60)
        pdf.cell(10,490,txt = add3[i])
   # for j in tqdm(range(100)):
pdf.output(r'C:\Users\nazrul\Desktop\SingleL\TESTING-main\OUTPUT\MBB001_TF.pdf')

# pdf_in = open(r'C:\Users\nazrul\Desktop\SingleL\TESTING-main\OUTPUT\MBB001_TF.pdf', 'rb')
...
# pdf_out = open(r'C:\Users\nazrul\Desktop\SingleL\TESTING-main\OUTPUT\MBB001_TF.pdf', 'wb')
# pdf_writer.write(pdf_out)
# pdf_out.close()
# pdf_in.close()

end_time = datetime.now().strftime("%H:%M:%S")
t1 = datetime.strptime(start_time, FMT)                             #untuk saaat running 
